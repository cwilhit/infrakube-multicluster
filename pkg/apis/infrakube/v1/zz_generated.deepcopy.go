...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TofuImages) DeepCopyInto(out *TofuImages) {
	*out = *in
	if in.Tofu != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TofuImages.
func (in *TofuImages) DeepCopy() *TofuImages {
	if in == nil {
		return nil
	}
	out := new(TofuImages)
...
func (in *TofuSpec) DeepCopyInto(out *TofuSpec) {
	*out = *in
	...
	in.TofuModule.DeepCopyInto(&out.TofuModule)
	if in.TaskOptions != nil {
		in, out := &in.TaskOptions, &out.TaskOptions
		*out = make([]TaskOption, len(*in))
		for i := range *in {
